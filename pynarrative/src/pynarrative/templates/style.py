    ...
    def __init__(self):
        super().__init__({
            ...
            'colors': {
                ...
                'subtitle': '#000000',
                'context': '#000000',
                'bar_highlight': 'rgb(255, 146, 95)',
                'bar_muted': 'rgb(156, 218, 247)',
                'callout_text': '#000000',
                'callout_arrow': '#CBB9B1',
                'callout_point': '#CBB9B1',
                'nextstep': '#EAEFF2',
                'nextstep_box': '#EAEFF2',
                'nextstep_border': 'transparent',
            ...
            'bar_fill_color': 'rgb(156, 218, 247)',
            'series_colors': ["rgb(156, 218, 247)", 'rgb(255, 146, 95)', "#8338EC", "#FF9F1C", "#E9C46A", "#2A9D8F", "#8AB17D", "#2EC4B6", "#6B2D5C", "#7B2CBF", "#4A4E69", "#6C757D"],
