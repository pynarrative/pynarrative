...
primary_color = "#c2a46c" #highlighted bar, text areas borders
tab_color = "#e0d1b4"
tab_border_color = primary_color

secondary_color = tab_color #normal bars
...
class BeigeStyle(Style):
    ...
    def __init__(self):
        ...
        self.set(
            ...
            bar_fill_color = primary_color,
            series_colors = [primary_color, "#27A0D9", "#348035", "#a46cc2", "#d96027"],

            reference_line_color = "#bf2626", #linea orizzontale/verticale
        )


class BeigeLayout(Layout):
    """
    Layout values.
    """
