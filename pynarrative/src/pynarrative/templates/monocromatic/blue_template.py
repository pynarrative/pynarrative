...
primary_color = "#27A0D9" #highlighted bar
tab_color = "#bfe3f4" #text areas background
...
class BlueStyle(Style):
    ...
    def __init__(self):
        ...
        self.set(
            ...
            series_colors = [primary_color,  "#d96027", "#348035", "#c2a46c", "#a46cc2"],

            reference_line_color = highlight_color, #linea orizzontale/verticale
        )


class BlueLayout(Layout):
    """
    Layout values.
    """
