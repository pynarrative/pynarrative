...
primary_color = "#668999" #highlighted bar
tab_color = "#becdd4" #text areas background
tab_border_color = primary_color

secondary_color = "#af9386" #normal bars
...
class GreyBrownTemplate(Template):
    """
    ...
    def __init__(self):
        super().__init__(
            style=GreyBrownStyle(),
            layout=GreyBrownLayout(),
        )
