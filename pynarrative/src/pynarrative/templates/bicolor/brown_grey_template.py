...
primary_color = "#af9386" # highligthed bars
tab_color = "#cbb9b1" #text areas background
tab_border_color = primary_color

secondary_color = "#7c9aa8" #normal bars
...
class BrownGreyTemplate(Template):
    """
    ...
    def __init__(self):
        super().__init__(
            style=BrownGreyStyle(),
            layout=BrownGreyLayout(),
        )
