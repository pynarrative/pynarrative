...
primary_color = "#6C8AC2" #highlighted bar
tab_color = "#CBDDFF" #text areas background
tab_border_color = primary_color

secondary_color = "#d4bf97" #normal bars
...
class BlueBeigeTemplate(Template):
    ...
    def __init__(self):
        super().__init__(
            style=BlueBeigeStyle(),
            layout=BlueBeigeLayout(),
        )
