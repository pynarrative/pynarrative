...
class DefaultLayout(Layout):
    ...
    def __init__(self):
        super().__init__({
            ...
            'nextstep_max_box_width': 240,
            'nextstep_chart_height_padding': 10,
            'nextstep_title_offset': 10,
            'context_left_width_ratio': 0.5,
            'context_left_height_ratio': 0.5,
            'context_right_width_ratio': 0.45,
            'context_right_height_ratio': 1.0,
            'context_top_width_ratio': 1.0,
            'context_top_height_ratio': 1 / 3,
            'context_bottom_width_ratio': 1.0,
            'context_bottom_height_ratio': 1 / 3,
            'layout_context_side_width_ratio': 0.5,
            'text_wrap_min_width': 120,
            'trendline_label_dx': 8,
