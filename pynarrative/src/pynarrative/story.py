...
class Story:
    ...
    def add_next_steps(self, 
        ...
        **kwargs):
        ...
        if next_step_instance is not None:
            return self.add_next_steps(**next_step_instance.to_dict())
        ...
        if button is not None:
            ...
            return self.add_next_steps(**button.to_dict())
            ...
            return self.add_next_steps(**line.to_dict())
    ...
    def _get_position(self, position, is_source=False):
        ...
        positions = {
            ...
            'side-left': (-110, self.chart.height / 2),  # 10 pixels to the left of the border, centred vertically
